...
const TRIP_DATA = {
  ...
  days: [
    ...
    {
      id: "aug12", city: "sf", dow: "Wed 8/12", title: "North Beach + Wharf → ALCATRAZ NIGHT 🔒 → night flight",
      stops: [
        ...
        { id: "sf-alcatraz", name: "ALCATRAZ NIGHT TOUR — Pier 33", time: "5:55 PM", category: "sight", area: "Embarcadero", notes: "Be at Pier 33 by 5:25pm. Book the 5:55 boat (back ~8:45pm). ~$60, official site only (alcatrazcitycruises.com) — sells out weeks out. COLD + windy: real jacket. Have bags staged for the airport run.", lat: 37.8067, lng: -122.4054, locked: true },
        { id: "sf-fly-la", name: "Night flight SFO → LAX", time: "LATE", category: "travel", area: "SFO", notes: "Pier 33 → SFO ≈ 30–40 min rideshare. Grab bags en route or stash them earlier. Rental car at LAX.", lat: 37.6213, lng: -122.3790, locked: true },
      ],
    },
    ...
    {
      id: "aug14", city: "la", dow: "Fri 8/14", title: "Westside all day: surf → Sugarfish → Venice → Gjelina",
      stops: [
        ...
        { id: "la-gjelina", name: "Gjelina — GROUP DINNER (party of 6)", time: "7:30 PM", category: "friends", area: "Venice", notes: "BOOK MID-JULY when the ~4–6-wk window opens: gjelina.com (SevenRooms) or call (310) 450-1429 if online caps below 6. Wood-fired pizzas, ~$60–90/pp.", lat: 33.9906, lng: -118.4643 },
      ],
    },
    {
      id: "aug15", city: "la", dow: "Sat 8/15", title: "Ojai day trip (w/ Sydney + Riley) → El Matador sunset",
      stops: [
        { id: "la-ojai-drive", name: "Leave by 8:30am — drive to Ojai", time: "8:30 AM", category: "travel", area: "Ojai", notes: "~1.5 hrs via the 101. Ojai hits 90s°F midday in August — do the town in the morning. (Alt trip: Catalina Express $99 RT from Long Beach — only if booked well ahead.)", lat: 34.4480, lng: -119.2429 },
        { id: "la-barts", name: "Bart's Books", time: "10:15 AM", category: "sight", area: "Ojai", notes: "The famous outdoor bookstore. Daily ~9:30am–6pm.", lat: 34.4497, lng: -119.2453 },
        { id: "la-ojai-town", name: "Downtown Ojai: arcade + Libbey Park + lunch", time: "11:30 AM", category: "food", area: "Ojai", notes: "Shops along Ojai Ave; pick one add-on: Ojai Olive Oil tasting (free), spa hour at Ojai Valley Inn, or Meditation Mount (needs online res).", lat: 34.4480, lng: -119.2429 },
        { id: "la-elmatador", name: "El Matador State Beach — sunset", time: "5 PM", category: "beach", area: "Malibu", notes: "Drive back via the coast. Sea stacks + caves, THE golden-hour beach. $8 lot is tiny — late afternoon it turns over. Sunset ~7:45pm. Steep stairs, no facilities.", lat: 34.0384, lng: -118.8746 },
        { id: "la-casual-dinner", name: "Casual dinner on the drive home", time: "8:30 PM", category: "food", area: "Wherever", notes: "No reservation — car votes. In-N-Out is legally required at least once.", lat: null, lng: null },
      ],
    },
    {
      id: "aug16", city: "la", dow: "Sun 8/16", title: "Slow Venice morning → fly home",
      stops: [
        { id: "la-gjusta", name: "Gjusta — breakfast", time: "9 AM", category: "cafe", area: "Venice", notes: "Gjelina Group's bakery-deli, 7am–4pm. Alt: Eggslut Venice (8am–2pm), 5 min away.", lat: 33.9946, lng: -118.4740 },
  ...
  extras: [
    ...
    { id: "x-catalina", city: "la", name: "Catalina Express (Long Beach)", category: "travel", area: "Day-trip alternate", notes: "$99 RT, 1-hr crossing, 6am–9pm summer boats. The 'epic' Saturday alternative — book immediately if chosen.", lat: 33.7627, lng: -118.1980 },
    { id: "x-meditation", city: "la", name: "Meditation Mount (Ojai)", category: "sight", area: "Ojai", notes: "Pink Moment sunset — needs an online reservation.", lat: 34.4530, lng: -119.2028 },
  ],
};
